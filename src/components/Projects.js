								...
								<div className="border-0 mb-4">
									<div className="card-header no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
										...
										<div className="d-flex py-2 project-tab flex-wrap w-sm-100">
											...
											<div
												className="nav nav-tabs tab-body-header rounded ms-3 prtab-set w-sm-100 nav nav-pills"
												role="tablist"
												>
												<div className="nav-item">
													<a
														...
														id="react-aria4425866692-:r3:-tab-All"
														aria-controls="react-aria4425866692-:r3:-tabpane-All"
														aria-selected="true"
												...
												<div className="nav-item">
													<a
														role="tab"
														data-rr-ui-event-key="Started"
														id="react-aria4425866692-:r3:-tab-Started"
														aria-controls="react-aria4425866692-:r3:-tabpane-Started"
														aria-selected="false"
														tabIndex={-1}
														className="nav-link"
														href="#"
												...
												<div className="nav-item">
													<a
														role="tab"
														data-rr-ui-event-key="Approval"
														id="react-aria4425866692-:r3:-tab-Approval"
														aria-controls="react-aria4425866692-:r3:-tabpane-Approval"
														aria-selected="false"
														tabIndex={-1}
														className="nav-link"
														href="#"
												...
												<div className="nav-item">
													<a
														role="tab"
														data-rr-ui-event-key="Completed"
														id="react-aria4425866692-:r3:-tab-Completed"
														aria-controls="react-aria4425866692-:r3:-tabpane-Completed"
														aria-selected="false"
														tabIndex={-1}
														className="nav-link"
														href="#"
							...
							<div className="row align-items-center">
								<div className="col-lg-12 col-md-12 flex-column">
									<div className="tab-content">
										<div
											role="tabpanel"
											id="react-aria4425866692-:r3:-tabpane-All"
											aria-labelledby="react-aria4425866692-:r3:-tab-All"
													...
													<div className="card">
														<div className="card-body">
															...
															<div className="d-flex align-items-center">
																<div className="avatar-list avatar-list-stacked pt-2">
																	<img
																		...
																		src="/template/my-task/react/static/media/avatar1.207e668ffe106473b1e6.jpg"
																		alt=" "
																		/>
																	<img
																		className="avatar rounded-circle sm"
																	...
																	<img
																		className="avatar rounded-circle sm"
																		src="/template/my-task/react/static/media/avatar4.14ba6a7378450f09f9d1.jpg"
																		alt=" "
																		/>
																	<img
																		className="avatar rounded-circle sm"
															...
															<div className="dividers-block" />
																...
																<div style={{ height: 8 }} className="progress">
																<div
																role="progressbar"
														...
														<div className="card-body">
															...
															<div className="d-flex align-items-center">
																<div className="avatar-list avatar-list-stacked pt-2">
																	...
																	<img
																		className="avatar rounded-circle sm"
																		src="/template/my-task/react/static/media/avatar5.0a8cb622a37a045bacb0.jpg"
																		alt=" "
																		/>
																	<img
																		className="avatar rounded-circle sm"
										...
										<div
											role="tabpanel"
											id="react-aria4425866692-:r3:-tabpane-Started"
											aria-labelledby="react-aria4425866692-:r3:-tab-Started"
										...
										<div
											role="tabpanel"
											id="react-aria4425866692-:r3:-tabpane-Approval"
											aria-labelledby="react-aria4425866692-:r3:-tab-Approval"
											className="fade tab-pane"
											>
											<div className="row g-3 gy-5 py-3 row-deck">
												<div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
										...
										<div
											role="tabpanel"
											id="react-aria4425866692-:r3:-tabpane-Completed"
											aria-labelledby="react-aria4425866692-:r3:-tab-Completed"
											className="fade tab-pane"
											>
											<div className="row g-3 gy-5 py-3 row-deck">
												<div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
